...
function renderMsg(opts, id, msg) {
  ...
  if (msg.author.publicWebHosting === false) return h('article', 'This user\'s content is not available on the web, load this link on a device with planetary installed to view.').outerHTML
